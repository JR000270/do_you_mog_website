...
const ImageProcessingPage = () => {
    ...
    return (
        <div>
            <h2 className="text-2xl font-semibold text-green-500">Upload Your Image</h2>
            <div>
            ...
            <div>
                {analysis && (
                    <div>
                        ...
                        <h4 className="text-lg font-medium text-gray-300">Most Mogging Features:</h4>
            ...
            <form onSubmit={(e) => { e.preventDefault(); handleSubmit(); }}>
                <input type="file" accept="image/*" onChange={handleFileChange} className="p-2 border border-gray-500 rounded mb-4 text-gray-300" />
